...
// 定义http请求handler
#define ReqHandler  std::function<bool (std::string, std::string, mg_connection *c, OnRspCallback)>
...
private:
	...
	static std::set<mg_connection *> s_websocket_session_set; // 缓存websocket连接
