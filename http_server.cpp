...
bool HttpServer::Start()
{
	...
	printf("started http server at port: %s\n", m_port.c_str());
	return true;
}
...
void HttpServer::OnHttpWebsocketEvent(mg_connection *connection, int event_type, void *event_data)
{
	...
	//mg_printf(connection, "%d", event_type);
	...
	//	{
	//		mg_printf(connection, "%s", "MG_EV_WEBSOCKET_HANDSHAKE_REQUEST");
	//	}
}
